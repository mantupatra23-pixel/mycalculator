    ...
    <main className="max-w-5xl mx-auto px-4 sm:px-6 pt-6 pb-16 space-y-8">
      ...
      <div>
        ...
        <p className="text-sm sm:text-base text-navy/75 max-w-2xl leading-relaxed">
          Browser-native financial algorithms for day traders, position traders, and risk managers. Model profit realizations, cap drawdowns, and account for official Indian taxes.
        </p>
      </div>
      ...
      {/* Category 2: Risk Management Tools */}
      ...
      {/* Category 3: Indian Brokerage & Taxes */}
      <div className="space-y-4 pt-4 border-t border-navy/10">
        <div className="flex items-center justify-between">
      ...
      {/* Future Categories Architecture Notice */}
      <div className="space-y-4 pt-4 border-t border-navy/10">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-bold text-navy">Planned Tool Categories (Phases 2 to 6)</h2>
          <span className="text-xs font-semibold text-navy/50">Expanding in phases</span>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {TRADING_CATEGORIES.slice(3).map((cat) => (
