...
export const CALCULATORS: CalculatorMeta[
  {
    ...
    name: "Parcel Real Earnings Calculator",
    category: "business",
    description: "Calculate how much you actually earn from each online order after product cost, shipping, marketplace fees, payment charges, GST, returns/RTO and other expenses.",
    keywords: ["parcel", "parcel real earnings", "ecommerce net profit", "rto", "returns", "meesho", "flipkart", "amazon", "parcel aya to kitna milega"],
    popular: true,
    featured: true,
  ...
  {
    id: "travel-real-cost-calculator",
    slug: "travel-real-cost-calculator",
    name: "Travel Real Cost Calculator",
    category: "other",
    description: "Calculate the true cost of your trip including transport, hotel, food, local travel, activities, fees and hidden expenses.",
    keywords: ["travel", "travel real cost", "trip cost", "trip ka kharcha", "holiday budget", "vacation expense", "traveler"],
    popular: true,
    featured: true,
    lastUpdated: "September 2026",
  ...
  {
    id: "construction-material-price-calculator",
    slug: "construction-material-price-calculator",
    name: "Construction Material Price Intelligence Calculator",
    category: "other",
    description: "Estimate construction material quantities, costs, wastage and total material budget for your project using your local market rates.",
    keywords: ["construction", "material cost", "price intelligence", "cement", "steel", "sand", "bricks", "building estimator"],
    popular: true,
    featured: true,
    lastUpdated: "September 2026",
