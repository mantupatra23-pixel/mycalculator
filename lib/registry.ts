...
export const CALCULATORS: CalculatorMeta[] = [
  ...
  },
  {
    ...
    featured: true,
    lastUpdated: "August 2026",
    formulaDescription: "Actual ROAS = Gross Revenue / Ad Spend | Break-Even ROAS = Gross Revenue / Net Contribution Margin",
    formulaVariables: [
      ...
      { symbol: "Contribution Margin", label: "Net Revenue remaining after COGS, Shipping, Packaging, Gateway, and Marketplace fees" },
      { symbol: "Max CAC", label: "Maximum allowable Customer Acquisition Cost to break even" },
    ],
    workedExample: {
      scenario: "100 units sold at ₹1,499 with ₹400 COGS, ₹120 Shipping/Packaging, ₹10,000 Overheads, 10% returns, and ₹25,000 Ad Spend",
      inputs: { "Selling Price": "₹1,499", "Delivered Orders": "100", "Ad Spend": "₹25,000", "COGS": "₹400/unit", "Returns": "10%", "Fixed Costs": "₹10,000" },
      result: "Gross Revenue: ₹1,49,900 | Actual ROAS: 6.00x | Break-Even ROAS: 2.04x | Net Profit: ₹38,466.30 | Max CAC: ₹634.66",
      explanation: "With a 6.00x actual ROAS against a 2.04x break-even requirement, the campaign achieves ₹38,466.30 net profit after fulfilling all non-ad variable costs and fixed overheads.",
    },
    assumptions: [
